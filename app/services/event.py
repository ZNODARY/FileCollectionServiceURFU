...
def create_event(session: Session, title: str, description: str | None, event_type: str, criteria: list, review_timeout_hours: int, created_by: int, peer_review_count: int = 2):
    event = Event(
        title=title,
